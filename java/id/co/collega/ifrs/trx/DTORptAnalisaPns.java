...
public class DTORptAnalisaPns {

	@CIPWidget(text = "No Nsb", widget = JenisWidgetEnum.TEXT, enable=false)
	private String CIFID;
	
	@CIPWidget(text = "Nama", widget = JenisWidgetEnum.TEXT,sizeHeader="400px",size="230px", enable=false)
	...
	@CIPWidget(text = "Bid Usaha", widget = JenisWidgetEnum.TEXT, intable=false)
	...
	@CIPWidget(text = "Alamat", widget = JenisWidgetEnum.TEXT, enable=false,sizeHeader="400px",size="230px" )
