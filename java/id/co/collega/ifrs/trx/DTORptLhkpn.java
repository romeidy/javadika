...
public class DTORptLhkpn {

	@CIPWidget(text = "Tgl Tx",size="80px", widget = JenisWidgetEnum.FTEXT,format=CIPCmpFormattedText.DATE_FORMAT,pattern="dd/MM/yyyy", enable=false, intable=false)
	private Date TGL_TX;
	
	@CIPWidget(text = "CIFID", widget = JenisWidgetEnum.TEXT, enable=false, visibleOnEdit=false)
	private String CIFID;
	
	@CIPWidget(text = "No Rekening", widget = JenisWidgetEnum.TEXT, enable=false, sizeHeader="100px")
	private String NO_REKENING;
	
	@CIPWidget(text = "Nama Lengkap", widget = JenisWidgetEnum.TEXT,sizeHeader="350px",size="230px", enable=false)
	private String NAMA_LENGKAP;
	
	@CIPWidget(text = "Keterangan", widget = JenisWidgetEnum.TEXT, enable=false,sizeHeader="300px")
	private String KETERANGAN_TX;
	
	@CIPWidget(text = "Jumlah Tx", widget = JenisWidgetEnum.LABEL,sizeHeader="100px",visibleOnEdit=false, align="right")
