...
public class SelectorComposer<T extends Component> implements Composer<T>, ComposerExt<T>,
	...
	/*	
	 * Untuk Insert log aktifitas User
	 */
	...
	/*	
	 * Check Hak untuk melakukan Insert
	 */
	public boolean checkPrivInsert(String user, String menuid){
		String sql = "SELECT FLGINSERT FROM CFG_USER_PRV_MENU WHERE USERID= ? AND MENUID= ?";
		DTOMap map = (DTOMap) masterService.getMapMaster(sql, new Object[]{user, menuid});
	 ...
	 */
	public boolean checkPrivDelete(String user, String menuid){
 ...
 */
	public boolean checkPrivUpdate(String user, String menuid){
